...
export const handleDarkBtnAction = () => {
	darkButton.addEventListener('click', () => {
		...
		if (sunImage.src.includes('icon-sun-dark.svg')) {
			sunImage.src = '/src/assets/images/icon-sun-light.svg'; // versión blanca para dark
		} else {
			sunImage.src = '/src/assets/images/icon-sun-dark.svg'; // versión negra para light
		}

		if (moonImage.src.includes('icon-moon-dark.svg')) {
			moonImage.src = '/src/assets/images/icon-moon-light.svg'; // versión blanca para dark
		} else {
			moonImage.src = '/src/assets/images/icon-moon-dark.svg'; // versión negra para light
		}
